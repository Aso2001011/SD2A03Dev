    ...
    <nav class="menu">
        <ul class="nav_menu2">
            ...
            if ($_SESSION['login']) {
                ...
                echo'<li class="nav_menu2_item login"><a href="new-user.php"><i class="fas fa-user-circle"></i>新規会員登録</a></li>';
                echo'<li class="nav_menu2_item"><a href="login2-in.php"><i class="fas fa-sign-in-alt"></i>ログイン</a></li>';
            }
            ?>
        </ul>
        <ul class="nav_menu3">
